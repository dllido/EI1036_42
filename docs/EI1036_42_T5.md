...
(Nota: JS original solo soporta var)
--
...
Ejemplos de métodos de los nodos: <img src="./media/T5/image6.png" width="40%" style="float:right ">
...
#### Atributos de los nodos
  ...
  - x.nodeName – Nombre del nodo x(no el atributo name)
...
- x.querySelector(mediaquery)   // Recuperar el primer nodo que cumple la condición 
- x.querySelectorAll(mediaquery) //Recuperar todos los nodos que cumplen la condición 
