...
<img src="./media/T4/template.png" height="70%"/>
...
- Los widgets, son bloques  que puedes añadir una gran selección de elementos: iconos de redes sociales, listado de entradas más vistas en el blog, categorías del sitio web, contacto… 
- El widget se programa en un bloque de código php que se puede poner en el functions.php de un tema o en un plugin en el fitxer plugin_name.php que se debe registrar en el WP,
