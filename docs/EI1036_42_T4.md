...
wordpress.org  -> (descargar WP para instalarlo en nuestros servidores o en local) 

wordpress.com -> (hosting con WP) 
...
- *Categoría*:  forma de agrupar y clasificar contenido en WordPress. Admite la construcción de jerarquías. Una página o una entrada puede pertenecer a una o varias categorías. 
- *Etiqueta* (tags) son etiquetas asociadas a las páginas, artículos o entradas para su organización.
