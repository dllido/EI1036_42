...
Un callback es un tipo de funciones que son pasadas como parametros y que serán ejecutadas desde una subrutina. 
...
Los hooks de accion o acciones son disparadas cuando  pasa algo, como que se cargue la página, se  inicie una sesion...
