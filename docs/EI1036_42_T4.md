...
-  *Atajos* (shortcode): permiten añadir funcionalidad de algúnos plugins en nuestra página web. Es  un  texto entre las marcas [ ], que  cuando la página es presentada al visitante, lo que hay entre las marcas se sustituye por el resultado de la función concreta que se ha invocado.
