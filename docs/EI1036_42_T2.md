...
(Drive/T2)
*https://drive.google.com/drive/folders/1T-U5nlyDrAgAMVmEbSIbJKWoQnhd7Lqf*
...
Subir los ficheros que están en el drive en el T2  al Git y al Wordpress

(Drive/T2)
*https://drive.google.com/drive/folders/1T-U5nlyDrAgAMVmEbSIbJKWoQnhd7Lqf*


- En el navegoador instalarar la extensión del navegador https://runmycode.online/. Así al editar los ficheros del git se puede directamente ejecutar online.

- La URL en wordpres debe ser algo semejante a la siguiente sustitullendo piruletas por vuestro nombre de tienda.
...
Seguridad: Ficheros sensibles deben estar fuera de la raiz del servidor web
https://piruletas.000webhostapp.com/wp-config.php
