...
Sería conveniente que los ficheros que están en el drive en el T2 

https://drive.google.com/drive/folders/1U8unry7CEj77DF9-dpq9JuAJ4ZQkjYWf?usp=sharing

- los subas al Git Teo/T2, e instalarais la extensión del navegador https://runmycode.online/. Así al editar los ficheros se puede directamente ejecutar online.

- y también  en el public_html/Teoria/T2 del portal de wordpress. De modo que podamos ver como funciona llamando a:
