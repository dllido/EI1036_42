...
- ¿Donde ponemos el fichero tutoPhp.php en el servidor para acceder desde http://localhost/teoria/T2/tutoPHP.php?
...
![Image of La World Wide Web](./media/T2/image2.png =100x20)
...
print_r($_SESSION);
 ```   
 Indica que aparece en la pantalla tras 2 veces de ejecutar ese fichero.
...
## ¿Dudas?
  ...
  ![Image de Dudas](./media/image8.png = 250x)
