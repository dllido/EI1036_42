...
| Success Resp. | Respuesta si el registro es correctamente   |
...
| Data Params   | validar fecha nacimiento |
| Success Resp. | mensaje registro correcto.    |
| Error Resp.   | mensaje registro incorrecto       |
