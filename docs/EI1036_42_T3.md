...
Buscando en estas guias https://www.w3.org/community/webed/wiki/CSS  (¿A que página te ha enviado?)
...
- Crea un pequeño formulario para registrarse en un gimnasio que utilice:
   ...
   * campo nombre con input type="text", campo dni input type="text"  

   * campo sexo con "input type=radio"

   * campo fecha  con un  "input type="date"

   * seleccionar multiples deportes con "select multiple". 
...
¿Que parámetros se envian al servidor? Utiliza las herramientas de desarrolladores.
