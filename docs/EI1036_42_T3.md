...
- Crea un pequepo formulario apuntarse a unos cursos de deporte que utilice el campo sexo con "input type=radio", edad con un select, que permita seleccionar multiples deportes con "select multiple". Trata consultando la guia de html poner más atributos a estos campos y con el CSS mejorar la apariencia del formulario. Por ejemplo una imagen de fondo al formulario, los textos con el tamaño requerido y con una fuente de distintos colores....
