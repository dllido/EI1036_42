...
padre.
-Ponemos elegir los nodos  del template y colonarlos añadiendo contenido y luego posicionandolos donde nos interese.
...
Ejercicio JS: Construir el Json 
...
- El uso compartido de recursos de origen cruzado (CORS- introducido en HTML5) permite a las aplicaciones web de un dominio realizar solicitudes
de dominio cruzado.
