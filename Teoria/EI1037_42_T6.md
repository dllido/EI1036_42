 ...
 **fetch(uri,request)**:  método  para hacer una solicitud  para solicitar el recurso *uri* con los parámetros del objeto *request* y devuelve una promesa *response*  que nos permite recuperar el recurso.  
