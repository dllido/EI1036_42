...
# Normativas accesibilidad Europea
 ...
 Norma UNE 139803:2012 (PDF) , es equivalente a las WCAG 2.0
   ...
   Es una Directiva (UE) 2016/2102 del Parlamento Europeo y del Consejo, de 26 de octubre de 2016, sobre la accesibilidad de los sitios web y aplicaciones moviles
...
-  Deberá ser transpuesta a la legislación española antes de septiembre de 2018,
 - Es el estándar europeo que especifica los requisitos funcionales de accesibilidad de los productos y
...
#### 4. Seguridad en la Comunicación;HTTPS
...
#### 6. Lenguajes de programación en servidor/cliente
