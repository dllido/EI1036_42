...
Anatomia de un tema: 
Imprimir: https://getflywheel.com/wp-content/uploads/2015/06/Anatomy-of-a-WordPress-Theme.png

Leer: https://yoast.com/wordpress-theme-anatomy/



![Template](./media/T4/template.png)

OBLIGATORIO index.php para tener un tema
...
Agregar hojas de estilo CSS (incluyendo style.css en sí) y archivos JavaScript
Registro de áreas del menú de navegación y áreas de widgets
Definición de los tamaños de imagen personalizados que desea que estén disponibles en su sitio
Filtrando el contenido de su página
...
Cuando una persona navega hacia su sitio web, WordPress selecciona qué plantilla usar para representar esa página. WordPress busca los archivos de plantilla en el siguiente orden:

Plantilla de página: si la página tiene una plantilla personalizada asignada, WordPress busca ese archivo y, si lo encuentra, lo usa.
page- {slug} .php: si no se ha asignado ninguna plantilla personalizada, WordPress busca y utiliza una plantilla especializada que contiene el slug de la página.
page- {id} .php: si no se encuentra una plantilla especializada que incluye el slug de la página, WordPress busca y utiliza una plantilla especializada con el nombre de la identificación de la página.
page.php: si no se encuentra una plantilla especializada que incluye la identificación de la página, WordPress busca y usa la plantilla de página predeterminada del tema.
singular.php: si no se encuentra page.php, WordPress busca y usa la plantilla del tema utilizada para una sola publicación, independientemente del tipo de publicación.
index.php: si no se asignan o encuentran plantillas de página específicas, WordPress volverá por defecto a utilizar el archivo de índice del tema para representar páginas.
Alerta:



HomePage: front-page.php-> home.php ->(page.php(static web)) o index.php (blog).

https://wphierarchy.com/

![Template](.https://developer.wordpress.org/files/2014/10/wp-hierarchy-1024x538.png)  


Entonces, al buscar la plantilla que se utilizará para presentar todas las publicaciones para un autor determinado, hagamos que el nombre de usuario de los autores, "david", tenga una identificación numérica de 3. (Seguramente una coincidencia); p) WordPress necesita saber qué archivo de su tema actual para usar. Así es como se ve a través de los archivos de tu tema:

¿Existe el archivo author-david.php? No…
¿Existe el archivo author-3.php? No…
¿Existe el archivo author.php? No…
¿Existe el archivo archive.php? No…
¿Existe el archivo index.php? ¡Sí!
---
...
![Template](./T4/loop.jpeg)  

The LOOP (Wordpress blog) 

(que se carta en la parte principal )
Como se carga una página web : The LOOP
https://visual.ly/community/infographic/computers/wordpress-theme-anatomy


https://thumbnails-visually.netdna-ssl.com/wordpress-theme-anatomy_52331b8175692_w1500.jpg


The Loop es el mecanismo predeterminado que WordPress usa para generar publicaciones a través de los archivos de plantilla de un tema. Es el código php que ponemos en index.php para visualizar los artículos de los blogs.



Comienza con una consulta URL y podemos especificar lo que se tiene que mostrar. Todo lo que está en medio depende de usted. Puede especificar el resultado de los títulos, publicar contenido, metadatos, campos personalizados y comentar todo dentro del ciclo, y cada elemento se publica para cada publicación o página hasta que finalice la consulta. Puede configurar múltiples bucles y consultas en una sola página; por ejemplo: en un single.php puede hacer que el ciclo muestre todo el contenido de una sola publicación, con un bucle que solo muestra títulos y miniaturas para publicaciones relacionadas debajo de él.
...
Una vez registrado al el widget gracias a add_action( 'widgets_init' lo podemos llamar desde cualquier parte. 


---
CustomFields

- Permitirle a los autores asignar campos personalizados a una entrada. Esta información arbitraria es conocida como metadatos.

- Los metadatos se manejan en pares de clave/valor.


Los autores pueden  asignar estos  e incluso crear nuevos.
Despues de escribir la entrada del blog, va al área titulada Custom Fields.
---
