...
- header.php: Cabecera común del portal. Todo lo que contiene la etiqueta  <head> o el menú de navegación principal.
...
- sidebar.php : Plantilla  una de barra lateral (sobre todo cuando se trata de un blog) o con widgets (por ejemplo un buscador, un listado de categorías o los posts más visitados).
- front-page.php: Plantilla con la página de inicio del blog. Está especialmente pensada para que sea un listado de entradas, es decir, la portada de un blog.
...
Ejemplo: twentyseventeen-child: Debe tener 2 ficheros: index.php (puede estar vacio) y style.css 
