...
Requiere autentificarse como Superadmin o Admin
...
Con más detalle el administrador podrá: 
...
- hojas de estilo CSS (incluyendo style.css en sí) 
- archivos JavaScript
...
- **page- {slug} .php:**:  plantilla especializada que contiene el slug de la página.
...
Según la jerarquia de WordPres:
- Primero lo busca  el fichero en el tema hijo.
- Luego lo busga en el tema por defecto.
...
- Adición de filtros mediante ```add_filter()``` que es un callback.
...
- $arg2 Prioridad.
- $arg3 Número de argumentos de la $function_to_add
...
Ejemplo complejo: https://getflywheel.com/wp-content/uploads/2015/06/Anatomy-of-a-WordPress-Theme.png
...
Función que se encarga de ejecutar los ganchos. 
...
Para crear un widged simplemente se crea un fichero php
en la  carpeta/
wp-content/plugins/my-widget/ el cual debe contener la instrucción register_widget('name') lo cual registra en el WP un widged llamado 'name'. Que podemos insertar en cualquier parte de la página web seleccionandolo de la lista de widgets activos. (https://www.axarnet.es/blog/como-crear-un-widget-en-wordpress/)
...
- Una cuestión frecuente en un sitio web es controlar el acceso de los usuarios a una zona determinada del mismo (autentorización), para ello se requiere solicitar generalmente la Autentificación previamente.
