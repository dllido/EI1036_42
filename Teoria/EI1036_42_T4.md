...
Sistema ficheros de un plugin según el esqueleto del ***boilerplate*** (http://wppb.io/) el cual se ha construido sobre la Worpress API, y siguiendo los estándares de codificación y los estándares de documentación recomendados por WordPress es:
```
/plugin-name
     plugin-name.php
     uninstall.php
