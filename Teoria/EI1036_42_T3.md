...
8. Sintaxis CSS
    ...
    - Medidas/Unidades
9. CSS3
10. CSS: Modelo de Cajas: flotantes/flexibles
...
* Mejor etiquetas en  minúsculas y atributos entre comillas dobles (xml).
...
* Organización lógica del documento.h1,h2,h3..
* Validar los documentos.
* No poner ```<table>``` para formatear.
* Intentar que sin las CSS se pueda entender el contenido.
* Resaltar los textos tanto con forma como color distintos.
* No utilizar espacios en blanco consecutivos:
``` css margin```
* Utilizar  etiquetas semánticas ```header,article....``` no siempre ```div```

---



# 4. HTML 5: http://www.w3.org/TR/html5/
...
- ¿Cómo seria la arquitectura?
- ¿Cómo funcionan los formularios?
- ¿conoceis alguna alternativa a formularios?
...
<p><a style=":hover {
transform: scale(1,5) translate(30px,10px);}"> Acción</a>
...
<a href="aqui" style="display:block; 
border: solid 4px rgb(204, 0, 0) ; 
background : #ffeebb ; "
>AQUI </a> Ya no es inline, es block.
<a href="alli" style="display:inline-block;
 border: solid 4px rgb(204, 0, 0) ; background : #ffeebb ; "
 >Alli</a> Esto es una caja inline, es block
```

<p> Esto es un párrafo, elemento block por defecto que contiene un trozo de texto <span> SPAN </span> que por defecto es inline</p>
<a href="aqui" style="display:block; border: solid 4px rgb(204, 0, 0) ; background : #ffeebb ; ">aqui</a> Ya no es inline, es block.
<a href="alli" style="display:inline-block; border: solid 4px rgb(204, 0, 0) ; background : #ffeebb ; ">Alli</a> Esto es una caja inline, es block
